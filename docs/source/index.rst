...
- Random sampling
- `Latin hypercube sampling <orthogonal_sampling.html#latin-hypercube-sampling>`_ (see `wikipedia <https://en.wikipedia.org/wiki/Latin_hypercube_sampling>`_ for an introduction)
